...
function Temp2 () {
  return (
    <div style={{ fontFamily: 'Georgia, serif', width: '210mm', height: '297mm', padding: '30px', border: '1px solid #ddd', boxShadow: '0px 4px 8px rgba(0,0,0,0.2)', lineHeight: '1.6', background: '#fff', color: '#333' }}>
    <header style={{ textAlign: 'center', marginBottom: '20px', paddingBottom: '10px', borderBottom: '2px solid #333' }}>
      <h1 style={{ margin: 0, fontSize: '26px', letterSpacing: '1px' }}>Babalo Mbulawa</h1>
      <p style={{ margin: 0 }}>
        Cape Town, 7784 | 067-980-6629 |{' '}
        <a href="mailto:babalombulawa@gmail.com" style={{ color: '#333', textDecoration: 'none' }}>babalombulawa@gmail.com</a>
      </p>
      <p style={{ margin: 0, fontWeight: 'bold' }}>Frontend Developer L1</p>
    </header>

    <section style={{ marginTop: '20px' }}>
      <h2 style={{ borderBottom: '2px solid #555', marginBottom: '10px', paddingBottom: '5px' }}>Summary</h2>
      <p>
    ...
    <section style={{ marginTop: '20px' }}>
      <h2 style={{ borderBottom: '2px solid #555', marginBottom: '10px', paddingBottom: '5px' }}>Experience</h2>
    ...
    <section style={{ marginTop: '20px' }}>
      <h2 style={{ borderBottom: '2px solid #555', marginBottom: '10px', paddingBottom: '5px' }}>Education</h2>
      ...
      <p><strong>Egghead.io — Online Learning</strong></p>
      <ul>
    ...
    <section style={{ marginTop: '20px' }}>
      <h2 style={{ borderBottom: '2px solid #555', marginBottom: '10px', paddingBottom: '5px' }}>Skills</h2>
      <p>HTML & CSS, JavaScript, React JS, C#, SQL, Git, GitHub</p>
    </section>

    <section style={{ marginTop: '20px' }}>
      <h2 style={{ borderBottom: '2px solid #555', marginBottom: '10px', paddingBottom: '5px' }}>Awards</h2>
      <p>Platinum Achievement in IT Engineering</p>
    </section>

    <footer style={{ textAlign: 'center', borderTop: '2px solid #333' }}>
      <p>LinkedIn: <a href="https://www.linkedin.com/in/babalo-mbulawa-3a49b219b" style={{ color: '#333', textDecoration: 'underline' }}>linkedin.com/in/babalo-mbulawa</a></p>
    </footer>
  </div>
  )
}
