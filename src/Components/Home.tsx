  ...
  return (
    <div className=" pt-20  px-12 flex ">
      <section className="flex flex-col gap-10 flex-1">
        <div>
          <h1 className=" font-ibmmono text-4xl font-bold">
            Create a Professional Resume with{" "}
            <span className="text-red-600">Rezume-TooL</span>
          </h1>
          <p className=" ibm-plex-mono-medium-italic ">
            A Resume that gets the Job DONE{" "}
            <span className="text-red-600">100%</span>
          </p>
          <br />{" "}
          <p className=" font-sans text-lg w-5/6">
        ...
        <div className="flex justify-evenly">
          <Link to="/create">
            {" "}
            <button className="  hover:shadow-cyan-300 transition-shadow h-16 w-36  rounded-lg bg-sky-500 shadow-lg shadow-black ibm-plex-mono-regular-italic hover:scale-105 ">
              Create CV
            </button>
          </Link>
          {/* <Link to='/templates'><img className=' h-64 w-44 shadow-2xl  shadow-zinc-500 rounded-md hover:shadow-sky-300 transition-shadow  hover:scale-105 ' src={smallCvimg} alt="" /> </Link>  */}
          <Link to="/templates">
            <img
              className="cv   h-64 w-44 shadow-2xl  shadow-zinc-500 rounded-md hover:shadow-sky-300 transition-shadow  hover:scale-105 "
              src={smallCvimg2}
              alt=""
            />{" "}
          </Link>
      ...
      <section className="flex-1 justify-items-center">
        <div className="   rounded-full border-2 border-slate-950 w-full justify-items-center">
